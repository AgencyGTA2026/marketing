...
export const metadata = buildPageMetadata({ title: "Practical Website & Automation Notes | Bayline Digital", description: "Practical notes on websites, local SEO, automation, landing pages, and digital operations from Bayline Digital.", path: "/blog" });
