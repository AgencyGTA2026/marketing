...
export const metadata = buildPageMetadata({ title: "Request Received | Bayline Digital", description: "Your inquiry was delivered to Bayline Digital.", path: "/thank-you", noIndex: true });
