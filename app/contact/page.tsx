...
export const metadata = buildPageMetadata({ title: "Contact Bayline Digital | Start a Project", description: "Tell Bayline Digital about your website, automation, SEO, or custom app project and receive a personal reply within one business day.", path: "/contact" });
