      ...
      <main>
          ...
          <div className="mx-auto w-full max-w-[1280px] px-8">
            ...
            <div className="mt-14 grid grid-cols-1 gap-5 lg:grid-cols-3">
              {service.deliverables.map((deliverable) => (
                <Reveal key={deliverable.title} className="flex min-h-[300px] flex-col rounded-[20px] border border-line bg-bg-card p-7 shadow-sm">
        ...
        <section className="py-24 border-t border-line bg-bg-sunken">
          <div className="mx-auto w-full max-w-[1280px] px-8">
            ...
            <div className="mt-14 overflow-hidden rounded-[20px] border border-line bg-line">
        ...
        <section className="py-24 border-t border-line bg-bg">
          <div className="mx-auto grid w-full max-w-[1280px] grid-cols-1 gap-10 px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            <Reveal className="rounded-[22px] border border-line bg-bg-card p-8 shadow-sm">
              ...
              <ul className="m-0 list-none p-0">
                {service.bestFit.bullets.map((bullet) => (
                  <li key={bullet} className="flex gap-3 border-t border-line py-4 text-[15px] text-ink-2 first:border-t-0 first:pt-0 last:pb-0">
