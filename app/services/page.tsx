...
export const metadata: Metadata = { title: "Websites, Web Apps & Automation | Bayline Digital", description: "Explore custom websites, landing pages, web apps, automation, SEO, and ongoing support from Bayline Digital.", alternates: { canonical: "/services" } };

export default function ServicesPage() {
  const services = Object.values(SERVICES_DATA);
  return <><Nav /><main>
    <section className="page-hero wrap"><p className="eyebrow">SERVICES</p><h1>Build the part that is holding growth back.</h1><p>Bayline combines clear websites, useful web applications, and practical automation. Start with the bottleneck, not a long list of technology.</p></section>
