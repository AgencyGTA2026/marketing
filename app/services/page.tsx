...
export const metadata = buildPageMetadata({ title: "Websites, Web Apps & Automation | Bayline Digital", description: "Explore custom websites, landing pages, web apps, automation, SEO, and ongoing support from Bayline Digital.", path: "/services" });
