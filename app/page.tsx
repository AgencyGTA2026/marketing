...
const improvements = [
  { number: "01", title: "Win trust sooner", description: "Conversion-focused websites that explain your value quickly, feel credible, and give customers a clear next step.", details: "Marketing websites · Landing pages · Local SEO" },
  { number: "02", title: "Turn an idea into a useful product", description: "Custom web apps that turn a focused idea into a working product, portal, or platform people can actually use.", details: "SaaS products · Client portals · Customer experiences" },
  { number: "03", title: "Replace the workarounds", description: "Internal tools and connected workflows that replace spreadsheet fixes, scattered handoffs, and repeated admin.", details: "Dashboards · Workflow automation · CRM integrations" },
];
...
export default function Home() {
  return <><Nav /><main>
    <section className="home-hero wrap" id="top">
      ...
      <div className="hero-bottom"><p>Bayline designs conversion-focused websites, builds custom web apps, and connects the systems behind them. Stronger first impressions. Simpler workflows. Less manual work.</p><div className="hero-actions"><PrimaryButton href="/contact">Talk through your project</PrimaryButton><a className="text-link" href="#work">View selected work ↓</a></div></div>
    </section>
